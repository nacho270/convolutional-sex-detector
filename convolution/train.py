...
if __name__ == '__main__':
    ...
    add_arg_param(parser, '--learning_rate', float, 0.001, 'How large a learning rate to use when training.')
    add_arg_param(parser, '--testing_percentage', int, 30, 'What percentage of images to use as a test set.')
