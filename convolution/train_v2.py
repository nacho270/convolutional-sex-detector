...
def detect_devices():
    ...
    if gpus:
        for g in gpus:
            tf.logging.info("GPU {} DETECTER".format(g).upper())
    else:
...
if __name__ == '__main__':
    ...
    add_arg_param(parser, '--tfhub_module', str, 'https://tfhub.dev/google/imagenet/mobilenet_v1_100_224/feature_vector/1', """\
